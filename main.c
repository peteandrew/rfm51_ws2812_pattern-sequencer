...
static void timer_led_value_change_handler(void * p_context)
{
    ...
    NRF_LOG_INFO("Led value change timer handler\r\n");
    pattern_sequencer_step();
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GATTS_EVT_WRITE:
            ...
            {
                uint8_t command = p_ble_evt->evt.gatts_evt.params.write.data[0];
                uint8_t data[4] = {
                    ...
                    p_ble_evt->evt.gatts_evt.params.write.data[4]
                };

                pattern_sequencer_command_entry(command, data);
            }
...
nrf_radio_signal_callback_return_param_t * radio_callback(uint8_t signal_type)
{
    switch(signal_type)
    {
        case NRF_RADIO_CALLBACK_SIGNAL_TYPE_START:
            ...
            nrf_gpio_pin_toggle(24); //Toggle LED4
...
int main(void)
{
    ...
    pattern_sequencer_init(&m_strip, NUM_LEDS);
